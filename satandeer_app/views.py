...
def index(request):
    ...
    return render(request, "satandeer_app/index.html")


def acerca_de(request):
    """ Vista o función que atiende la url GET /acerca-de/ """
    return render(request, "satandeer_app/acerca-de.html")


def tarjetas(request):
    """ Vista o función que atiende la url GET /tarjetas/ """
    tarjetas_all = Tarjeta.objects.all()
    return render(request, "satandeer_app/tarjetas.html",
                  {
...
def portal(request):
    ...
    return render(request, "satandeer_app/portal.html",
                  {
